...
This package intentionally has no runtime dependencies. The npm package is restricted to the plugin entry point, type declarations, license, notice, README, and security policy through the `files` allowlist in `package.json`.
