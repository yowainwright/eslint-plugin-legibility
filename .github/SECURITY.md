...
This package intentionally has no runtime dependencies. The npm package is restricted to the plugin entry point, type declarations, license, notice, and README through the `files` allowlist in `package.json`.
